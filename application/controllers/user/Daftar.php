...
class Daftar extends CI_Controller {
    ...
    function proses_daftar(){
        ...
        $params['alamat']   = $this->input->post('alamat');
            ...
            $cek = $this->Users_model->get(array('user_name' => $params['user_name']));
            ...
            if ($cek) {
                ...
                <?php
                echo "<meta http-equiv='refresh' content='0; url=".base_url()."user/daftar'>";
            } else {
                ...
                <?php
                echo "<meta http-equiv='refresh' content='0; url=".base_url()."user/auth'>";
            }
    }
